    ...
    <ScrollView indicatorStyle="white" style={styles.container}>
      <View>
        ...
        <Text style={styles.text}>
          StockStop was created as a helpful resource for anyone interested in
          learning about the most actively traded stocks on one of the largest
          stock exchanges in the world, the NASDAQ Exchange.
        </Text>
        <Text style={styles.text}>
          Three APIs were used to fetch the data displayed throughout this
          application:
        </Text>
        <List.Item
          title="Twelve Data"
