...
export default function StockInfoScreen({route, navigation}) {
    ...
    return (
        <ScrollView style={styles.container}>
          <Text style={styles.text}>{description.stockName}</Text>
          <Text style={styles.text}>Sector: {description.sector}</Text>
          <Text style={styles.text}>Industry: {description.industry}</Text>
          <ScrollView>
            <Text style={styles.text}>Description: {description.description}</Text>
          </ScrollView>
          <Button
